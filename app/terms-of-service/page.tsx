...
export default function TermsOfServicePage() {
	return (
		<LegalPage
			...
			updated="Sagyboar.space · Last Updated: January 2026"
		>
			...
			<section className="flex flex-col gap-2">
				...
				<p>
					...
					<a href="mailto:help@Sagyboar.space">help@Sagyboar.space</a> with as
					much information as you have including, but not limited to, the date
					and time of the violation and any identifying information regarding
					the violator including e-mail or IP address, if available.
				</p>
				...
				<p>
					Customer represents that it is not located in, under the control of,
					or a national or resident of any country subject to a U.S. government
					embargo, and that it is not listed on any U.S. government denied-party
					list. Customer agrees not to use the Services in violation of
			...
			<section className="flex flex-col gap-2">
				...
				<p>
					...
					<a href="/sla">Service Level Agreement</a> for plan-specific uptime,
					response, and support commitments.
				</p>
				<h3 className="text-xl font-medium">7.1 Uptime Commitment</h3>
				<p>
					We commit to 99.9% monthly uptime for the Cloud Services, measured as:
			...
			<section className="flex flex-col gap-2">
				...
				<p>
					...
					<a href="mailto:help@Sagyboar.space">help@Sagyboar.space</a> or chat
					during Monday-Friday, 9am-6pm EST. Response times vary by plan tier as
			...
			<section className="flex flex-col gap-2">
				...
				<p>
					...
					request via our <a href="/contact">contact page</a>.
				</p>
				<h3 className="text-xl font-medium">
			...
			<section className="flex flex-col gap-2">
				...
				<p>
					...
					Sagyboar in marketing materials, case studies, website pages
					(including a &quot;customers&quot; or &quot;trusted by&quot; page),
					press releases, and investor presentations (&quot;Marketing
					Use&quot;).
				</p>
				<h4 className="text-lg font-medium">10.4.2 Restrictions</h4>
				<p>
					Sagyboar&apos;s Marketing Use of your name and logo is subject to the
					following conditions: (a) Sagyboar shall use your logo only in the
					form you have provided or approved, and in accordance with any brand
			...
			<section className="flex flex-col gap-2">
				...
				<p>
					Certain features of the Services, including AI Monitoring, AI Error
					Diagnosis, and Self-Healing, may take automated actions on
					Customer&apos;s applications or infrastructure without prior human
					approval, based on AI-driven anomaly detection. We do not warrant that
					any AI-driven actions, including self-healing remediation, will be
					error-free or achieve any particular outcome. Where the platform
					supports it, Customer may disable or configure the level of human
					oversight for autonomous actions. Liability arising from AI-driven
					actions is subject to the same Limitation of Liability cap set forth
					in Section 15.
				</p>
			</section>
			...
			<section className="flex flex-col gap-2">
				...
				<p>
					[CONFIRM: whether disputes are resolved by binding AAA arbitration in
					Delaware, or by courts in Delaware — draft arbitration text if
					selected: Any dispute arising from these Terms shall be resolved by
					binding arbitration administered by AAA in accordance with its
					Commercial Arbitration Rules. The arbitration shall be conducted in
					the State of Delaware. The arbitrator&apos;s decision shall be final
					and binding.]
				</p>
			...
			<section className="flex flex-col gap-2">
				...
				<h3 className="text-xl font-medium">19.2 Waivers and Severability</h3>
				<p>
				...
				<h3 className="text-xl font-medium">19.7 Independent Contractors</h3>
				<p>
			...
			<section className="flex flex-col gap-2 border-t pt-8">
				...
				<p className="mt-4">
					...
					contact <a href="mailto:help@Sagyboar.space">help@Sagyboar.space</a>.
				</p>
			</section>
		</LegalPage>
	);
