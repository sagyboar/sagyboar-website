...
export default function SlaPage() {
	return (
		<LegalPage
			...
			updated="Sagyboar.space · Last Updated: July 2026"
		>
			<section className="flex flex-col gap-4">
				...
				<p>
					...
					&quot;us&quot;) provides for <strong>Cloud Services</strong> on paid
					subscription plans. It applies in addition to our{" "}
					<Link href="/terms-of-service">Terms of Service</Link> and is
					incorporated by reference therein.
				</p>
				<p>
					The SLA does <strong>not</strong> apply to the Free plan, self-hosted
					(on-premise) installations, beta or preview features, or outages
					...
					<table className="w-full min-w-[640px] text-left text-sm">
						<thead>
							<tr className="border-b border-sagy-border bg-sagy-heading/[0.04]">
								...
								<th className="font-semibold">Support</th>
							</tr>
						</thead>
						<tbody>
			...
			<section className="flex flex-col gap-4">
				...
				<p>
					<strong>Downtime</strong> means periods when the Cloud Services are
					unavailable to you, excluding Scheduled Maintenance and the exclusions
					listed in Section 8.
				</p>
			</section>
			...
			<section className="flex flex-col gap-4">
				...
				<p>
					...
					Sagyboar acknowledges the ticket and begins investigation. Targets by
					severity:
				</p>
				<ul className="list-inside list-disc space-y-2">
					<li>
						<strong>Critical</strong> — production outage or severe security
						issue: within the plan response target (15–60 minutes depending on
						tier)
					</li>
					<li>
						<strong>High</strong> — major feature degradation: within 4 business
						hours
					</li>
					<li>
						<strong>Normal</strong> — non-urgent issues: within 1 business day
					</li>
				</ul>
				<h3 className="text-xl font-medium">2.2 Resolution time</h3>
				<p>
					For <strong>critical</strong> incidents, we will use commercially
					reasonable efforts to restore service or provide a workaround within{" "}
					<strong>4 hours</strong> of acknowledgment. Resolution time depends on
					incident complexity; we will keep you updated on progress until the
			...
			<section className="flex flex-col gap-4">
				...
				<ul className="list-inside list-disc space-y-2">
					<li>
						<strong>{starterPlan.name}</strong> — Monday through Friday, 9 AM–6
						PM EST (business hours)
					</li>
					<li>
						<strong>{growthPlan.name}</strong> — 24 hours a day, 7 days a week
					</li>
					<li>
						<strong>{enterprisePlan.name}</strong> — 24×7 priority support with
				...
				<p>
					...
					or through your dashboard support channel. For critical outages, mark
					your ticket as <strong>Critical</strong> and include affected
			...
			<section className="flex flex-col gap-4">
				...
				<ul className="list-inside list-disc space-y-2">
					...
					<li>
						<strong>30-day retention</strong> — backup copies are retained for
						up to 30 days unless a longer period is agreed in your enterprise
						agreement
					</li>
				</ul>
				<p>
					Backups are stored in geographically separate infrastructure. You are
					responsible for testing restore procedures for your own application
					data where self-managed components apply.
				</p>
			</section>
			...
			<section className="flex flex-col gap-4">
				...
				<ul className="list-inside list-disc space-y-2">
					...
					<li>
						Access controls, audit logging, and incident response aligned with
			...
			<section className="flex flex-col gap-4">
				...
				<p>
					Credit requests must be submitted within <strong>30 days</strong> of
					the incident. Credits do not exceed one month&apos;s fees and cannot
			...
			<section className="flex flex-col gap-4">
				...
				<div className="rounded-xl border border-sagy-accent/20 bg-sagy-accent/[0.06] p-5">
					...
					<p className="mt-3">
						...
						ticket. We acknowledge within 60 minutes and work to restore service
						within 4 hours. If monthly uptime falls below 99.9%, you can request
						a service credit on your next invoice.
					</p>
				</div>
			</section>
			...
			<section className="flex flex-col gap-4">
				...
				<ul className="list-inside list-disc space-y-2">
					...
					<li>
						Force majeure, internet or DNS provider failures, and third-party
