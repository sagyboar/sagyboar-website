...
const configFeatures = [
	...
	},
	{
		...
		description:
			"Decide on your retention period and an automated cron job will clean old metrics. Choose which port the Sagyboar metrics server listens on—the default is 4500.",
	},
	{
		icon: Server,
...
const relatedFeatures = [
	...
	},
	{
		...
		description:
			"Provision, manage, and back up databases without leaving Sagyboar.",
...
const faqs = [
	...
	},
	{
		...
		answer:
			"The best server monitoring software depends on what you need to monitor and whether you want open-source control or a managed SaaS. If you're using Sagyboar, you get real-time server monitoring as part of your solution on all plans—with no additional setup required once your server is deployed.",
	},
];
				...
				<Container className="relative z-10">
					...
					<div className="mx-auto mt-12 max-w-7xl overflow-hidden rounded-xl border border-border bg-card shadow-2xl sm:mt-16">
						<Image
							...
							alt="Sagyboar container monitoring dashboard with CPU, memory, and network graphs"
							width={1200}
							height={750}
			...
			<section className="border-b border-border py-20 sm:py-32">
				<Container>
					<div className="mx-auto max-w-5xl text-center">
						...
						<p className="mt-4 text-lg text-muted-foreground">
							Use Sagyboar&apos;s container monitoring dashboard as soon as
							you&apos;ve completed the server deployment setup.
						</p>
					</div>
					<div className="mx-auto mt-12 max-w-5xl rounded-xl border border-border bg-card p-8 text-center">
			...
			<section className="border-b border-border py-20 sm:py-32">
				<Container>
					<div className="mx-auto max-w-5xl text-center">
						...
						<p className="mt-4 text-lg text-muted-foreground">
							Set up your Sagyboar dashboard to suit your needs with different
							configuration options.
						</p>
					</div>
					<div className="mx-auto mt-16 grid max-w-5xl gap-8 sm:grid-cols-2">
			...
			<section className="border-b border-border bg-muted/30 py-20 sm:py-32 dark:bg-muted/10">
				<Container>
					<div className="mx-auto max-w-5xl text-center">
						...
						<p className="mt-4 text-lg text-muted-foreground">
							Take advantage of Sagyboar&apos;s comprehensive container and server
				...
				<Container>
					<div className="mx-auto max-w-5xl text-center">
						...
						<p className="mt-4 text-lg text-muted-foreground">
							...
							Sagyboar&apos;s built-in monitoring.
						</p>
						<div className="mt-10 flex flex-wrap items-center justify-center gap-4">
							<Button className="rounded-full" asChild>
								<Link href="/contact">Contact sales</Link>
