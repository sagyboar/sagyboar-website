...
export default function PrivacyPage() {
	return (
		<LegalPage title="Privacy Policy" titleHighlight="Policy">
			<section className="flex flex-col gap-4">
				...
				<p>
					...
					hosted platform (dashboard.sagyboar.space). By using Sagyboar, you
					agree to the practices described in this policy. If you do not agree
					with these practices, please do not use our services.
				</p>
			</section>
			...
			<section className="flex flex-col gap-4">
				...
				<div className="flex flex-col gap-2">
					...
					<p>
						...
						information and usage statistics (for example, page views and
						session duration) to generate anonymised reports. This data helps us
						understand how users interact with the site and improve the user
						experience. We do not combine this data with information that
				...
				<div className="flex flex-col gap-2">
					...
					<p>
						...
						process server metrics, logs, and deployment data using AI/ML models
						to detect anomalies and generate diagnostics or remediation actions.
						[CONFIRM: whether this processing uses third-party AI model
						providers such as OpenAI, Anthropic, or similar — and name the
						providers actually used.] Logs and metrics processed by AI are used
						solely to operate the Service and are not used to train third-party
						foundation models unless explicitly stated otherwise. Where
						supported, customers can configure retention and redaction settings
						for logs containing sensitive data.
					</p>
				</div>
			</section>
			...
			<section className="flex flex-col gap-4">
				...
				<p>
					Sagyboar uses cookies and similar technologies for two purposes: (1)
					to manage user sessions (authentication cookies) and (2) to run
					analytics and marketing tools. Google Analytics sets cookies to
					distinguish individual browsers and report usage statistics. HubSpot
					sets cookies to track visits, remember preferences and send marketing
					messages. You can opt out of Google Analytics by installing the Google
					Analytics opt‑out browser add‑on or by adjusting your browser settings
					to block cookies. HubSpot's tracking can be limited by adjusting
					cookie preferences in the cookie banner (when available) or by sending
					a "Do Not Track" signal through your browser. If you disable cookies
			...
			<section className="flex flex-col gap-4">
				...
				<ul className="list-inside list-disc space-y-1">
					...
					<li>
						...
						credentials you provide only to deliver the service. Credentials are
						retained only for as long as the associated integration is active
						and are deleted within [CONFIRM: number of days] of disconnection.
					</li>
				</ul>
				<p>
			...
			<section className="flex flex-col gap-4">
				...
				<p>
					...
					data. Sagyboar does not sell your personal data.
				</p>
				<p>
					To exercise these rights or opt out of analytics and marketing
					cookies, please contact us at{" "}
					<a href="mailto:help@Sagyboar.space">help@Sagyboar.space</a>. We will
					honour verified requests within the time frames required by law.
				</p>
			</section>
			...
			<section className="flex flex-col gap-4">
				...
				<p>
					...
					knowingly collect personal data from anyone under 18. If we learn we
			...
			<section className="flex flex-col gap-4">
				...
				<p>
					...
					your country of residence, including the United States. Such transfers
					are made pursuant to appropriate safeguards (for example, Standard
					Contractual Clauses) as described in the Data Processing Addendum
					referenced in our <a href="/terms-of-service">Terms of Service</a>.
				</p>
			</section>
			...
			<section className="flex flex-col gap-4">
				...
				<p>
					...
					notify affected individuals and/or relevant authorities without undue
					delay as required by applicable law.
				</p>
			</section>
			...
			<section className="flex flex-col gap-4">
				...
				<p>
					...
					by using the account deletion option in your dashboard settings (where
					available) or by emailing{" "}
					<a href="mailto:help@Sagyboar.space">help@Sagyboar.space</a>. After we
					verify and process your request, we will delete or anonymise your
					personal data within [CONFIRM: number of days] days, except where we
					are required to retain information to comply with legal obligations,
			...
			<section className="flex flex-col gap-4">
				...
				<p>
					Email: <a href="mailto:help@Sagyboar.space">help@Sagyboar.space</a>
				</p>
			</section>
		</LegalPage>
	);
