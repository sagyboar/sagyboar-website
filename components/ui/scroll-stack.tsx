...
export const ScrollStackItem: React.FC<ScrollStackItemProps> = ({
	...
	<div
		className={cn(
			"scroll-stack-card relative my-8 box-border h-72 w-full origin-top rounded-3xl border border-border bg-card p-8 shadow-lg will-change-transform sm:h-80 sm:p-10",
			itemClassName,
		)}
		style={{
