			...
			<div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
				{whyChooseSagyboar.map((entry) => {
					...
					return (
						<article
							key={entry.title}
							className="sagy-spotlight sagy-tilt flex flex-col rounded-xl border border-sagy-border bg-sagy-surface p-6 shadow-sagy-card transition-colors hover:border-sagy-accent/25"
						>
