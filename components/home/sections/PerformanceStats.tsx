						...
						return (
							<ScrollRevealItem key={stat.label}>
								...
								>
									...
									<p className="font-display text-4xl uppercase tracking-tight text-sagy-heading sm:text-5xl">
										{stat.metric}
									</p>
									<p className="mt-2 font-sans text-sm font-medium text-sagy-heading">
										{stat.label}
									</p>
