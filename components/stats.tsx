...
function getGrid({
	...
	return [
		{
			title: "GitHub Stars",
			description: `With over ${(githubStars / 1000).toFixed(1)}k stars on GitHub, Sagyboar is trusted by developers worldwide. Explore our repositories and join our community!`,
			icon: (
		...
		},
		{
			...
			description: `Downloaded over ${Math.floor(dockerDownloads / 1000000)}M times, Sagyboar has become a go-to solution for seamless deployments. Discover our presence on DockerHub.`,
			icon: (
				<svg
					stroke="currentColor"
					fill="currentColor"
		...
		},
		{
			...
			description: `Thanks to our growing base of over ${contributors} contributors, Sagyboar continues to thrive, with valuable contributions from developers around the world.`,
		...
		{
			title: "Sponsors",
			description: `More than ${defaultStats.sponsors} companies/individuals have sponsored Sagyboar, ensuring a steady flow of support and resources. Join our community!`,
