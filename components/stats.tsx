...
import { Activity, Blocks, Clock, ShieldCheck } from "lucide-react";
		...
		<div className="flex flex-col gap-10 px-4 py-20 lg:py-40">
			<div className="mx-auto max-w-2xl md:text-center">
				...
				<p className="mt-4 text-center text-lg tracking-tight text-muted-foreground">
					We built Sagyboar to remove bottlenecks. Experience enterprise-grade
					reliability, instant deployments, and proactive AI monitoring from day
					one.
				</p>
			</div>
