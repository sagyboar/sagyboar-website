...
const semanticColors = {
	...
	"accent-hover": "rgb(var(--sagy-accent-hover) / <alpha-value>)",
	"accent-soft": "rgb(var(--sagy-accent-soft) / <alpha-value>)",
	"accent-foreground": "rgb(var(--sagy-accent-foreground) / <alpha-value>)",
...
const tailwindTheme = {
	...
	boxShadow: {
		...
		"sagy-glow": "0 0 40px rgba(166, 123, 91, 0.3)",
